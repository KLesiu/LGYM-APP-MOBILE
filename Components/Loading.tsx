...
const Loading:React.FC<LoadingProps>=(props)=>{
    ...
    useEffect(()=>{
        ...
        setTimeout(()=>changeWidth(width),1000)
    },[width])
        ...
        <View style={LoadingStyles.loadingContainer}>
            ...
            <View style={LoadingStyles.loadingDiv}>
                <View style={LoadingStyles.loadingHolder}>
                    <View style={{backgroundColor:'grey',borderRadius:10,height:'100%',width:`${width}%`,zIndex:7,}}></View>
                </View>
                <Text style={{fontFamily:"Teko_400Regular",...LoadingStyles.loadingDivP}}>Loading...</Text>
            </View>
        </View>
    )
}
