  ...
  return (
      <View className=" relative w-full bg-[#131313]">
        ...
        <View className="w-full h-12 flex flex-row pr-6">
            <Pressable className="flex flex-row justify-center items-center flex-1" style={{borderBottomColor:`${styleCurrentTab(<MainProfileInfo/>,'border')}`,borderBottomWidth:1}}  onPress={()=>setCurrentTab(<MainProfileInfo logout={logout}/>)}><Text className="text-gray-200/80 font-light leading-4 text-center w-20 text-sm" style={{fontFamily:'OpenSans_300Light',color:`${styleCurrentTab(<MainProfileInfo/>,'text')}`}}>Data</Text></Pressable>
            <Pressable className="flex flex-row justify-center items-center flex-1" style={{borderBottomColor:`${styleCurrentTab(<Records toggleMenuButton={props.toggleMenuButton}/>,'border')}`,borderBottomWidth:1}} onPress={()=>setCurrentTab(<Records toggleMenuButton={props.toggleMenuButton}/>)}><Text className="text-gray-200/80 font-light leading-4 text-center w-20 text-sm" style={{fontFamily:'OpenSans_300Light',color:`${styleCurrentTab(<Records toggleMenuButton={props.toggleMenuButton}/>,'text')}`}}>Records</Text></Pressable>
