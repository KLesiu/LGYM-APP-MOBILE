  ...
  return (
    <View className="absolute w-full h-full top-0 flex flex-col items-center justify-center bg-[#000000f4] p-6 z-50">
      ...
      <TextInput
        ...
        className="h-12 text-[15px] w-4/5 border-[#3c3c3c] border-[2px] mt-[5px] pl-[15px] text-white"
        placeholder="Username"
        onChangeText={(text: string | "") => setUserId(text)}
      ></TextInput>
      <Pressable
        style={{ borderRadius: 12 }}
        className="w-40 h-12  bg-green-500 flex justify-center items-center mt-[5%]"
        onPress={() => importPlan()}
      >
        <Text
