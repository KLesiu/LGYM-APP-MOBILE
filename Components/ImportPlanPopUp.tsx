...
const ImportPlanPopUp:React.FC<ImportPlanPopUpProps>=(props)=>{
    ...
    return(
        <View style={ImportPlanPopUpStyles.importPlanPopUp}>
            <Text style={{fontFamily:'Teko_700Bold',...ImportPlanPopUpStyles.h2}}>If you want to copy someone plan you need to have a userId!</Text>
            <TextInput style={ImportPlanPopUpStyles.input} placeholder='UserID' onChangeText={(text:string|'')=>setUserId(text)}></TextInput>
            <TouchableOpacity style={ImportPlanPopUpStyles.button} onPress={()=>importPlan()}><Text>COPY!</Text></TouchableOpacity>
        </View>
