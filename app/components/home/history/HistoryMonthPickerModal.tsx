  ...
  return (
    <Modal transparent animationType="fade" visible={visible} onRequestClose={onClose}>
      <View className="flex-1 justify-center items-center bg-black/60 px-4">
        <View className="w-full max-w-[360px] rounded-xl bg-[#282828] p-4" style={{ gap: 12 }}>
          <View className="w-full flex-row items-center justify-between">
            ...
            <Text style={{ fontFamily: 'OpenSans_700Bold' }} className="text-textColor text-lg">
              {visibleMonthTitle}
            </Text>
            <TouchableOpacity
              className="h-8 w-8 items-center justify-center rounded-md bg-[#1f1f1f]"
          ...
          <View className="w-full flex-row flex-wrap" style={{ rowGap: 8 }}>
            {monthGridDays.map((date, index) => {
              ...
              return (
                <View key={dateKey} className="w-[14.28%] h-10 items-center justify-center">
                  <TouchableOpacity
                  ...
                  >
                    <Text
                      style={{
                        fontFamily: isSelected ? 'OpenSans_700Bold' : 'OpenSans_400Regular',
                      }}
                      className={`text-sm ${isSelected ? 'text-black' : 'text-textColor'}`}
                    >
                      {date.getDate()}
                    </Text>
                    {isTrainingDay && (
          ...
          >
            <Text style={{ fontFamily: 'OpenSans_700Bold' }} className="text-textColor text-base">
              {closeLabel}
            </Text>
          </TouchableOpacity>
        </View>
