...
const TrainingDayChoose: React.FC<TrainingDayChooseProps> = ({ showDaySection, goBack }) => {
  ...
  return (
    <Dialog>
      <View className="flex flex-col justify-center w-full p-4" style={{ gap: 8 }}>
