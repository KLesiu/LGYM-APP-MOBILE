...
const Training: React.FC = () => {
  ...
  const { data: planCheckResponse, isLoading } = useGetApiIdCheckIsUserHavePlan(userId, {
    query: {
      enabled: !!userId,
  ...
  const isUserHavePlan = useMemo(() => planCheckResponse?.data ?? false, [planCheckResponse]);
