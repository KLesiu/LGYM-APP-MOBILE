  ...
  return (
    <View className="w-full px-5 flex flex-col flex-1" style={{ gap: 4 }}>
      <View className="flex flex-row justify-between">
        ...
        <Text
          className="smallPhone:text-[12px] midPhone:text-sm text-white  w-2/5"
          style={{
            fontFamily: "OpenSans_300Light",
          }}
        >
          ...
          {Array.from({ length: currentExercise!.series }).map((_, index) => {
            ...
            return (
              <View
                ...
                style={{ gap: 10 }}
              >
                <View className="bg-secondaryColor smallPhone:px-2 smallPhone:py-1  midPhone:px-4 midPhone:py-3 rounded-lg ">
                ...
                <TextInput
                  ...
                  className="smallPhone:text-[11px] midPhone:text-sm  bg-secondaryColor w-2/5 smallPhone:px-2 smallPhone:py-1   midPhone:px-4 midPhone:py-3  text-white"
                />
                <TextInput
                  onChangeText={(value) =>
                    updateExerciseScore(
                  ...
                  keyboardType="numeric"
                  className="smallPhone:text-[11px] midPhone:text-sm   bg-secondaryColor  text-white smallPhone:px-2 smallPhone:py-1   midPhone:px-4 midPhone:py-3 w-2/5 "
                />
              </View>
            );
          })}
